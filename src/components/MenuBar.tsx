      ...
      <div className="flex gap-4 justify-center items-center">
        ...
        {loading ? (
          ...
          <>
            <Link
              href="/login"
              className="dark:text-white text-black text-xs dark:bg-[#333B47] bg-gray-200 px-2 py-[7px] rounded-md font-semibold dark:hover:bg-[#444C57] hover:bg-gray-100 transition hover:text-gray-700"
            >
              Đăng nhập
            </Link>
            <button className="text-black bg-[#FCD535] hover:bg-yellow-400 px-2 py-[7px] rounded-md text-xs font-semibold transition">
              Đăng ký
            </button>
          </>
        )}
