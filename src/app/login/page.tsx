...
export default function LoginPage() {
  return (
    <div className="bg-[#181A20] min-h-screen flex flex-col justify-center items-center">
      <div className="rounded-2xl border-[0.5px] border-gray-500 min-w-[425px] bg-[#181A20]">
        <div className="p-10">
          ...
          <p className="text-white text-[15px] py-2">Email/Số điện thoại</p>
          <div className="flex flex-col gap-5">
            <input
              type="text"
              className="border border-gray-500 rounded-xl p-3 text-white text-[15px]"
            ...
            />
            <button className="bg-[#FCD535] rounded-xl p-3 text-black">
              Tiếp tục
            </button>
          </div>
        </div>
